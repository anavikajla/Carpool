...
<div class="form-group">
    <label for="number-of-riders">Number of Preferred Riders</label>
    <input type="number" class="form-control" id="number-of-riders">
</div>

<div class ='form-group'>
    <label for="charge">Any charges? </label>
<div class="radio-inline">
    <label>
        <input type="radio" name="optionsRadios" id="charge" value="option1" checked>
        Yes
    </label>
</div>
<div class="radio-inline">
    <label>
        <input type="radio" name="optionsRadios" id="charge" value="option2">
       No
    </label>
</div>
</div>
